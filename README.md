...
- **Data science & modelling**  
  Building classification and regression models for problems such as disease identification, plant species classification, and house-price prediction.
...
## 📈 Selected Projects and Focus Areas
...
In my upcoming data portfolio, I will publish these and new projects with:
...
My goal is to continue growing as a data professional by building practical, end-to-end projects that demonstrate my ability to:

1. Understand a business or real-world problem.
2. Collect, clean, and prepare data.
3. Explore data and identify meaningful patterns.
4. Build appropriate analytical or predictive models.
5. Create clear visualizations and reports.
6. Communicate insights and recommendations effectively.
...
- [ ] Continuously update this profile with new work and learning.
